...
road = Road((0,0), [
    [Lane((1, 1, 0), 0, 1)], [Lane((0, 1, 0), 0, 0)]
    ], 15)
# Road now accepets list[list[Lane]] not list[Lane]
# list[list[Lane]] oppeates as a list[tuple[Lane, Lane]]
...
# Intersection now dirives pos from sim array indexes on draw_update
